...
class ConcurrentReferenceHashMapFake<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    /**
     * Create a new {@code ConcurrentReferenceHashMapFake} instance.
     */
    public ConcurrentReferenceHashMapFake() {
     ...
     */
    public ConcurrentReferenceHashMapFake(int initialCapacity) {
     ...
     */
    public ConcurrentReferenceHashMapFake(int initialCapacity, float loadFactor) {
     ...
     * write to the map
     */
    public ConcurrentReferenceHashMapFake(int initialCapacity, int concurrencyLevel) {
     ...
     */
    public ConcurrentReferenceHashMapFake(int initialCapacity, ReferenceType referenceType) {
     ...
     * write to the map
     */
    public ConcurrentReferenceHashMapFake(int initialCapacity, float loadFactor, int concurrencyLevel) {
    ...
    public boolean containsKey(Object key) {
        Entry<K, V> entry = getEntryIfAvailable(key);
        return (entry != null && ObjectUtilsFake.nullSafeEquals(entry.getKey(), key));
    }
    ...
    public boolean remove(Object key, final Object value) {
        return doTask(key, new Task<Boolean>(TaskOption.RESTRUCTURE_AFTER, TaskOption.SKIP_IF_EMPTY) {
            ...
            protected Boolean execute(Reference<K, V> ref, Entry<K, V> entry) {
                if (entry != null && ObjectUtilsFake.nullSafeEquals(entry.getValue(), value)) {
                    ref.release();
                    return true;
                }
                return false;
    ...
    public boolean replace(K key, final V oldValue, final V newValue) {
        return doTask(key, new Task<Boolean>(TaskOption.RESTRUCTURE_BEFORE, TaskOption.SKIP_IF_EMPTY) {
            @Override
            protected Boolean execute(Reference<K, V> ref, Entry<K, V> entry) {
                if (entry != null && ObjectUtilsFake.nullSafeEquals(entry.getValue(), oldValue)) {
            ...
            while (currRef != null) {
                if (currRef.getHash() == hash) {
                    ...
                    if (entry != null) {
                        ...
                        if (ObjectUtilsFake.nullSafeEquals(entryKey, key)) {
                            return currRef;
                        }
                    }
                }
    ...
    protected static final class Entry<K, V> implements Map.Entry<K, V> {
        ...
        public final boolean equals(Object other) {
            ...
            return (ObjectUtilsFake.nullSafeEquals(getKey(), otherEntry.getKey()) &&
                    ObjectUtilsFake.nullSafeEquals(getValue(), otherEntry.getValue()));
        }

        @Override
        public final int hashCode() {
            return (ObjectUtilsFake.nullSafeHashCode(this.key) ^ ObjectUtilsFake.nullSafeHashCode(this.value));
        }
    }
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object o) {
            if (o instanceof Map.Entry<?, ?>) {
                ...
                Reference<K, V> ref = ConcurrentReferenceHashMapFake.this.getReference(entry.getKey(), Restructure.NEVER);
                Entry<K, V> otherEntry = (ref != null ? ref.get() : null);
                if (otherEntry != null) {
                    return ObjectUtilsFake.nullSafeEquals(otherEntry.getValue(), otherEntry.getValue());
                }
            }
            return false;
        }
        ...
        public boolean remove(Object o) {
            if (o instanceof Map.Entry<?, ?>) {
                Map.Entry<?, ?> entry = (Map.Entry<?, ?>) o;
                return ConcurrentReferenceHashMapFake.this.remove(entry.getKey(), entry.getValue());
            }
            return false;
        }
        ...
        @Override
        public int size() {
            return ConcurrentReferenceHashMapFake.this.size();
        }

        @Override
        public void clear() {
            ConcurrentReferenceHashMapFake.this.clear();
        }
    }
    ...
    private class EntryIterator implements Iterator<Map.Entry<K, V>> {
        ...
        private void moveToNextSegment() {
            ...
            if (this.segmentIndex < ConcurrentReferenceHashMapFake.this.segments.length) {
                this.references = ConcurrentReferenceHashMapFake.this.segments[this.segmentIndex].references;
                this.segmentIndex++;
            }
        }
        ...
        public void remove() {
            ...
            ConcurrentReferenceHashMapFake.this.remove(this.last.getKey());
        }
    }
    ...
    protected class ReferenceManager {
        ...
        public Reference<K, V> createReference(Entry<K, V> entry, int hash, Reference<K, V> next) {
            if (ConcurrentReferenceHashMapFake.this.referenceType == ReferenceType.WEAK) {
