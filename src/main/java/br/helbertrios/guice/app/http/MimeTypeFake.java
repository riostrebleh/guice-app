...
public class MimeTypeFake implements Comparable<MimeTypeFake>, Serializable {
     ...
     */
    public MimeTypeFake(String type) {
     ...
     * @throws IllegalArgumentException if any of the parameters contains illegal characters
     */
    public MimeTypeFake(String type, String subtype) {
     ...
     * @throws IllegalArgumentException if any of the parameters contains illegal characters
     */
    public MimeTypeFake(String type, String subtype, Charset charset) {
     ...
     * @since 4.3
     */
    public MimeTypeFake(MimeTypeFake other, Charset charset) {
     ...
     * @throws IllegalArgumentException if any of the parameters contains illegal characters
     */
    public MimeTypeFake(MimeTypeFake other, Map<String, String> parameters) {
     ...
     * @throws IllegalArgumentException if any of the parameters contains illegal characters
     */
    public MimeTypeFake(String type, String subtype, Map<String, String> parameters) {
        checkToken(type);
        checkToken(subtype);
        this.type = type.toLowerCase(Locale.ENGLISH);
        this.subtype = subtype.toLowerCase(Locale.ENGLISH);
        if (!CollectionUtilsFake.isEmpty(parameters)) {
            Map<String, String> map = new LinkedCaseInsensitiveMapFake<String>(parameters.size(), Locale.ENGLISH);
     ...
     *
     * @see MimeTypeUtilsFake#parseMimeType(String)
     */
    public static MimeTypeFake valueOf(String value) {
        return MimeTypeUtilsFake.parseMimeType(value);
    }
     ...
     */
    public boolean includes(MimeTypeFake other) {
        if (other == null) {
            return false;
        }
        if (isWildcardType()) {
     ...
     * {@code false} otherwise
     */
    public boolean isCompatibleWith(MimeTypeFake other) {
        if (other == null) {
            return false;
        }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MimeTypeFake)) {
            return false;
        }
        MimeTypeFake otherType = (MimeTypeFake) other;
     ...
     * @since 4.2
     */
    private boolean parametersAreEqual(MimeTypeFake other) {
        ...
        for (String key : this.parameters.keySet()) {
            ...
            if (PARAM_CHARSET.equals(key)) {
                if (!ObjectUtilsFake.nullSafeEquals(getCharset(), other.getCharset())) {
                    return false;
                }
            } else if (!ObjectUtilsFake.nullSafeEquals(this.parameters.get(key), other.parameters.get(key))) {
                return false;
            }
        }
     ...
     * @see MimeTypeUtilsFake#sortBySpecificity(List)
     */
    @Override
    public int compareTo(MimeTypeFake other) {
    ...
    public static class SpecificityComparator<T extends MimeTypeFake> implements Comparator<T> {
