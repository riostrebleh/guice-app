...
class HttpServletResponseFake implements HttpServletResponse {
    ...
    private final ServletOutputStream outputStream = new HttpServletResponseFake.ResponseServletOutputStream(this.content);
    ...
    private String characterEncoding = WebUtilsFake.DEFAULT_CHARACTER_ENCODING;
    ...
    public PrintWriter getWriter() throws UnsupportedEncodingException {
        ...
        if (this.writer == null) {
            ...
            this.writer = new HttpServletResponseFake.ResponsePrintWriter(targetWriter);
        }
        return this.writer;
    }
    ...
    public boolean containsHeader(String name) {
        return (HeaderValueHolderFake.getByName(this.headers, name) != null);
    }
     ...
     */
    private class ResponseServletOutputStream extends DelegatingServletOutputStreamFake {
