...
class HttpSessionFake implements HttpSession {
    ...
    /**
     * Create a new MockHttpSession with a default {@link ServletContextFake}.
     *
     ...
     */
    public HttpSessionFake(ServletContext servletContext) {
     ...
     */
    public HttpSessionFake(ServletContext servletContext, String id) {
    ...
    public String[] getValueNames() {
        assertIsValid();
        return StringUtilsFake.toStringArray(this.attributes.keySet());
    }
