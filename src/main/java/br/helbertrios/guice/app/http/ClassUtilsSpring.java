...
abstract class ClassUtilsSpring {
    ...
    public static ClassLoader getDefaultClassLoader() {
        ...
        if (cl == null) {
            ...
            cl = ClassUtilsSpring.class.getClassLoader();
            if (cl == null) {
    ...
    public static String classNamesToString(Collection<Class<?>> classes) {
        if (CollectionUtilsFake.isEmpty(classes)) {
            return "[]";
        }
            ...
            try {
                if (Modifier.isPublic(method.getModifiers())) {
                    ...
                    Method specificMethod =
                            ReflectionUtilsFake.findMethod(targetClass, method.getName(), method.getParameterTypes());
